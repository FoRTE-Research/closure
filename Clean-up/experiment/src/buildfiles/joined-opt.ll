; ModuleID = 'buildfiles/joined-opt.bc'
...
@PTRTRACKER_copy = common global [100 x i8*] zeroinitializer, align 16
@RANDOM_INIT_copy = global i32 0, align 4
@hashArray_copy = common global [20 x %struct.DataItem*] zeroinitializer, align 16
@dummyItem_copy = common global %struct.DataItem* null, align 8
@t_copy = common global i64 0, align 8
@timeinfo_copy = common global %struct.tm* null, align 8
@RANDOM_UNIT_copy = common global i32 0, align 4
@item_copy = common global %struct.DataItem* null, align 8
...
424:                                              ; preds = %413
  call void @longjmp([1 x %struct.__jmp_buf_tag]* @_buf, i32 1)
...
22:                                               ; preds = %16
  %23 = load %struct.DataItem*, %struct.DataItem** @item_copy
  store %struct.DataItem* %23, %struct.DataItem** @item
  %24 = load i32, i32* @RANDOM_UNIT_copy
  store i32 %24, i32* @RANDOM_UNIT
  %25 = load %struct.tm*, %struct.tm** @timeinfo_copy
  store %struct.tm* %25, %struct.tm** @timeinfo
  %26 = load i64, i64* @t_copy
  store i64 %26, i64* @t
  %27 = load %struct.DataItem*, %struct.DataItem** @dummyItem_copy
  store %struct.DataItem* %27, %struct.DataItem** @dummyItem
  %28 = load [20 x %struct.DataItem*], [20 x %struct.DataItem*]* @hashArray_copy
  store [20 x %struct.DataItem*] %28, [20 x %struct.DataItem*]* @hashArray
  %29 = load i32, i32* @RANDOM_INIT_copy
  store i32 %29, i32* @RANDOM_INIT
  %30 = load [100 x i8*], [100 x i8*]* @PTRTRACKER_copy
  store [100 x i8*] %30, [100 x i8*]* @PTRTRACKER
  %31 = load %struct.ptr_obj*, %struct.ptr_obj** @ptr_map_copy
  store %struct.ptr_obj* %31, %struct.ptr_obj** @ptr_map
  %32 = load i32, i32* @_ctr_copy
  store i32 %32, i32* @_ctr
  %33 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i64 0, i64 0))
  %34 = call i32 @start_main(i32 %0, i8** %1)
  br label %35
...
define dso_local void @insert(i32 %0, i32 %1) #0 {
  ...
  %7 = call noalias i8* @myMalloc(i64 8) #7
...
25:                                               ; preds = %2
  ...
  call void @possibleExit()
  %32 = call noalias i8* @myMalloc(i64 8) #7
