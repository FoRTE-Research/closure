; ModuleID = 'buildfiles/prog.bc'
source_filename = "testfiles/random_exit_hashmap.c"
...
define dso_local void @insert(i32 %0, i32 %1) #0 {
  ...
  %7 = call noalias i8* @malloc(i64 8) #4
...
define dso_local void @doStuff() #0 {
  %1 = call i64 @time(i64* @t) #4
  %2 = call %struct.tm* @localtime(i64* @t) #4
