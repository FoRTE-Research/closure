; ModuleID = 'buildfiles/stub_noprint.bc'
source_filename = "stubMain_noprint.c"
...
@.str = private unnamed_addr constant [12 x i8] c"Start_Main\0A\00", align 1
...
14:                                               ; preds = %10
  ...
  %16 = call i32 @start_main(i32 %0, i8** %1)
  br label %17
