...
@.str = private unnamed_addr constant [23 x i8] c"Allocated Pointer: %d\0A\00", align 1
@.str.1 = private unnamed_addr constant [21 x i8] c"Freeing Pointer: %d\0A\00", align 1
@.str.2 = private unnamed_addr constant [88 x i8] c"/Users/ianpaterson/Downloads/Grad_Research-main/experiment/src/results/results_temp.txt\00", align 1
@.str.3 = private unnamed_addr constant [2 x i8] c"w\00", align 1
@_buf = common dso_local global [1 x %struct.__jmp_buf_tag] zeroinitializer, align 16
@.str.4 = private unnamed_addr constant [27 x i8] c"\0A!!!Saved by long jump!!!\0A\00", align 1
@.str.5 = private unnamed_addr constant [19 x i8] c"\0A___Start_Main___\0A\00", align 1
@.str.6 = private unnamed_addr constant [4 x i8] c"%f\0A\00", align 1
@.str.7 = private unnamed_addr constant [26 x i8] c"\0A---Done with Testing---\0A\00", align 1
@.str.8 = private unnamed_addr constant [18 x i8] c"Time to test: %f\0A\00", align 1
...
define dso_local i8* @myMalloc(i64 %0) #0 {
  ...
  %7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str, i64 0, i64 0), i8* %6)
...
define dso_local void @myFree(i8* %0) #0 {
  ...
  %4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.1, i64 0, i64 0), i8* %3)
  %5 = load i8*, i8** %2, align 8
  %6 = ptrtoint i8* %5 to i32
  %7 = call %struct.ptr_obj* @find_ptr(i32 %6)
  call void @delete_ptr(%struct.ptr_obj* %7)
...
define dso_local i32 @main(i32 %0, i8** %1) #0 {
  ...
  %13 = call %struct._IO_FILE* @fopen(i8* getelementptr inbounds ([88 x i8], [88 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0))
...
18:                                               ; preds = %15
  ...
  %20 = call i32 @_setjmp(%struct.__jmp_buf_tag* getelementptr inbounds ([1 x %struct.__jmp_buf_tag], [1 x %struct.__jmp_buf_tag]* @_buf, i64 0, i64 0)) #10
  %21 = icmp ne i32 %20, 0
  br i1 %21, label %22, label %24

22:                                               ; preds = %18
  %23 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.4, i64 0, i64 0))
  br label %27

24:                                               ; preds = %18
  %25 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.5, i64 0, i64 0))
...
27:                                               ; preds = %24, %22
  ...
  %36 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %34, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.6, i64 0, i64 0), double %35)
  br label %37
...
40:                                               ; preds = %15
  %41 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.7, i64 0, i64 0))
  %42 = call i64 @clock() #7
  ...
  %49 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.8, i64 0, i64 0), double %48)
  ret i32 0
}
