...
@.str.1.69 = private unnamed_addr constant [7 x i8] c"shmget\00", align 1
@.str.2.70 = private unnamed_addr constant [6 x i8] c"shmat\00", align 1
@.str.3.71 = private unnamed_addr constant [26 x i8] c"\0A---Done with Testing---\0A\00", align 1
@.str.4.72 = private unnamed_addr constant [19 x i8] c"\0A___Start_Main___\0A\00", align 1
...
@file_queue_copy = common global [65 x %union.anon.0] zeroinitializer, align 16
@queue_head_copy = common global i32 0, align 4
@queue_tail_copy = common global i32 0, align 4
@used_slots_copy = common global %union.sem_t* null, align 8
@unused_slots_copy = common global %union.sem_t* null, align 8
@queue_mutex_copy = common global %union.pthread_mutex_t zeroinitializer, align 8
...
define dso_local i32 @main(i32 %0, i8** %1) #15 {
  ...
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.68, i64 0, i64 0))
  %11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.68, i64 0, i64 0))
  store i32 5678, i32* %7, align 4
  %12 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.68, i64 0, i64 0))
  %13 = load i32, i32* %7, align 4
  %14 = call i32 @shmget(i32 %13, i64 1, i32 438) #21
  store i32 %14, i32* %6, align 4
  %15 = icmp slt i32 %14, 0
  br i1 %15, label %16, label %17

16:                                               ; preds = %2
  call void @perror(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1.69, i64 0, i64 0))
  call void @exit(i32 1) #22
  unreachable

17:                                               ; preds = %2
  %18 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.68, i64 0, i64 0))
  %19 = load i32, i32* %6, align 4
  %20 = call i8* @shmat(i32 %19, i8* null, i32 0) #21
  %21 = bitcast i8* %20 to i32*
  store i32* %21, i32** %8, align 8
  %22 = icmp eq i32* %21, inttoptr (i64 -1 to i32*)
  br i1 %22, label %23, label %24

23:                                               ; preds = %17
  call void @perror(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2.70, i64 0, i64 0))
  call void @exit(i32 1) #22
  unreachable

24:                                               ; preds = %17
  %25 = call i32 @_setjmp(%struct.__jmp_buf_tag* getelementptr inbounds ([1 x %struct.__jmp_buf_tag], [1 x %struct.__jmp_buf_tag]* @__longjmp_buf__, i64 0, i64 0)) #26
  %26 = load i32, i32* @total_count_copy, align 4
  store i32 %26, i32* @total_count, align 4
  %27 = load %union.pthread_mutex_t, %union.pthread_mutex_t* @queue_mutex_copy, align 8
  store %union.pthread_mutex_t %27, %union.pthread_mutex_t* @queue_mutex, align 8
  %28 = load %union.sem_t*, %union.sem_t** @unused_slots_copy, align 8
  store %union.sem_t* %28, %union.sem_t** @unused_slots, align 8
  %29 = load %union.sem_t*, %union.sem_t** @used_slots_copy, align 8
  store %union.sem_t* %29, %union.sem_t** @used_slots, align 8
  %30 = load i32, i32* @queue_tail_copy, align 4
  store i32 %30, i32* @queue_tail, align 4
  %31 = load i32, i32* @queue_head_copy, align 4
  store i32 %31, i32* @queue_head, align 4
  %32 = load [65 x %union.anon.0], [65 x %union.anon.0]* @file_queue_copy, align 8
  store [65 x %union.anon.0] %32, [65 x %union.anon.0]* @file_queue, align 8
  %33 = load %union.pthread_mutex_t, %union.pthread_mutex_t* @output_mutex_copy, align 8
  store %union.pthread_mutex_t %33, %union.pthread_mutex_t* @output_mutex, align 8
  %34 = load %struct._MODULE_DATA*, %struct._MODULE_DATA** @modules_data_list_copy, align 8
  store %struct._MODULE_DATA* %34, %struct._MODULE_DATA** @modules_data_list, align 8
  %35 = load i8, i8* @show_version_copy, align 1
  store i8 %35, i8* @show_version, align 1
  %36 = load i32, i32* @timeout_copy, align 4
  store i32 %36, i32* @timeout, align 4
  %37 = load i32, i32* @threads_copy, align 4
  store i32 %37, i32* @threads, align 4
  %38 = load [33 x i8*], [33 x i8*]* @tags_copy, align 8
  store [33 x i8*] %38, [33 x i8*]* @tags, align 8
  %39 = load i32, i32* @stack_size_copy, align 4
  store i32 %39, i32* @stack_size, align 4
  %40 = load i32, i32* @skip_larger_copy, align 4
  store i32 %40, i32* @skip_larger, align 4
  %41 = load i8, i8* @scan_list_search_copy, align 1
  store i8 %41, i8* @scan_list_search, align 1
  %42 = load i8, i8* @recursive_search_copy, align 1
  store i8 %42, i8* @recursive_search, align 1
  %43 = load i8, i8* @show_tags_copy, align 1
  store i8 %43, i8* @show_tags, align 1
  %44 = load i8, i8* @show_string_length_copy, align 1
  store i8 %44, i8* @show_string_length, align 1
  %45 = load i8, i8* @show_strings_copy, align 1
  store i8 %45, i8* @show_strings, align 1
  %46 = load i8, i8* @show_stats_copy, align 1
  store i8 %46, i8* @show_stats, align 1
  %47 = load i8, i8* @show_namespace_copy, align 1
  store i8 %47, i8* @show_namespace, align 1
  %48 = load i8, i8* @show_module_data_copy, align 1
  store i8 %48, i8* @show_module_data, align 1
  %49 = load i8, i8* @show_meta_copy, align 1
  store i8 %49, i8* @show_meta, align 1
  %50 = load i8, i8* @ignore_warnings_copy, align 1
  store i8 %50, i8* @ignore_warnings, align 1
  %51 = load i8, i8* @follow_symlinks_copy, align 1
  store i8 %51, i8* @follow_symlinks, align 1
  %52 = load i8, i8* @negate_copy, align 1
  store i8 %52, i8* @negate, align 1
  %53 = load [33 x i8*], [33 x i8*]* @modules_data_copy, align 8
  store [33 x i8*] %53, [33 x i8*]* @modules_data, align 8
  %54 = load i32, i32* @max_strings_per_rule_copy, align 4
  store i32 %54, i32* @max_strings_per_rule, align 4
  %55 = load i32, i32* @limit_copy, align 4
  store i32 %55, i32* @limit, align 4
  %56 = load i32, i32* @max_process_memory_chunk_copy, align 4
  store i32 %56, i32* @max_process_memory_chunk, align 4
  %57 = load [33 x i8*], [33 x i8*]* @identifiers_copy, align 8
  store [33 x i8*] %57, [33 x i8*]* @identifiers, align 8
  %58 = load i8, i8* @show_help_copy, align 1
  store i8 %58, i8* @show_help, align 1
  %59 = load i8, i8* @fast_scan_copy, align 1
  store i8 %59, i8* @fast_scan, align 1
  %60 = load i8, i8* @fail_on_warnings_copy, align 1
  store i8 %60, i8* @fail_on_warnings, align 1
  %61 = load [33 x i8*], [33 x i8*]* @ext_vars_copy, align 8
  store [33 x i8*] %61, [33 x i8*]* @ext_vars, align 8
  %62 = load i8, i8* @print_count_only_copy, align 1
  store i8 %62, i8* @print_count_only, align 1
  %63 = load i8, i8* @rules_are_compiled_copy, align 1
  store i8 %63, i8* @rules_are_compiled, align 1
  %64 = load i8*, i8** @atom_quality_table_copy, align 8
  store i8* %64, i8** @atom_quality_table, align 8
  %65 = load [31 x %struct._args_option], [31 x %struct._args_option]* @options_copy, align 8
  store [31 x %struct._args_option] %65, [31 x %struct._args_option]* @options, align 8
...
77:                                               ; preds = %73
  %78 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.3.71, i64 0, i64 0))
  call void @longjmp([1 x %struct.__jmp_buf_tag]* @__longjmp_buf__, i32 1)
  call void @exit(i32 1) #22
  unreachable
...
83:                                               ; preds = %67
  %84 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.4.72, i64 0, i64 0))
  %85 = call i32 @start_main(i32 %0, i8** %1)
  call void @free_ptrs()
