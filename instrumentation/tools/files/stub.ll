...
@.str.3 = private unnamed_addr constant [26 x i8] c"\0A---Done with Testing---\0A\00", align 1
@.str.4 = private unnamed_addr constant [19 x i8] c"\0A___Start_Main___\0A\00", align 1
...
define dso_local i32 @main(i32 %0, i8** %1) #0 {
  ...
  %12 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0))
  %13 = load i32, i32* %7, align 4
  %14 = call i32 (i32, i32, i32, ...) bitcast (i32 (...)* @shmget to i32 (i32, i32, i32, ...)*)(i32 %13, i32 1, i32 438)
...
17:                                               ; preds = %2
  %18 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0))
  %19 = load i32, i32* %6, align 4
  %20 = call i32 (i32, i8*, i32, ...) bitcast (i32 (...)* @shmat to i32 (i32, i8*, i32, ...)*)(i32 %19, i8* null, i32 0)
  %21 = sext i32 %20 to i64
  %22 = inttoptr i64 %21 to i32*
  store i32* %22, i32** %8, align 8
  %23 = icmp eq i32* %22, inttoptr (i64 -1 to i32*)
...
25:                                               ; preds = %17
  %26 = call i32 @_setjmp(%struct.__jmp_buf_tag* getelementptr inbounds ([1 x %struct.__jmp_buf_tag], [1 x %struct.__jmp_buf_tag]* @__longjmp_buf__, i64 0, i64 0)) #10
...
38:                                               ; preds = %34
  %39 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.3, i64 0, i64 0))
  call void @exit(i32 1) #8
  unreachable
...
44:                                               ; preds = %28
  %45 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.4, i64 0, i64 0))
  %46 = call i32 @start_main(i32 %0, i8** %1)
  call void @free_ptrs()
  %47 = load i32*, i32** %8, align 8
  store i32 -2, i32* %47, align 4
  call void @longjmp(%struct.__jmp_buf_tag* getelementptr inbounds ([1 x %struct.__jmp_buf_tag], [1 x %struct.__jmp_buf_tag]* @__longjmp_buf__, i64 0, i64 0), i32 1) #8
  unreachable
}

declare dso_local i32 @printf(i8*, ...) #5

declare dso_local i32 @shmget(...) #5

declare dso_local void @perror(i8*) #5

declare dso_local i32 @shmat(...) #5
