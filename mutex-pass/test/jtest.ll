...
11:                                               ; preds = %8
  %12 = call i32 @setjmp(i32* getelementptr inbounds ([37 x i32], [37 x i32]* @_buf, i64 0, i64 0)) #6
  %13 = icmp ne i32 %12, 0
...
30:                                               ; preds = %11
  %31 = load %struct.DataItem*, %struct.DataItem** @item_copy, align 8
  store %struct.DataItem* %31, %struct.DataItem** @item, align 8
  %32 = load i32, i32* @RANDOM_UNIT_copy, align 4
  store i32 %32, i32* @RANDOM_UNIT, align 4
  %33 = load %struct.tm*, %struct.tm** @timeinfo_copy, align 8
  store %struct.tm* %33, %struct.tm** @timeinfo, align 8
  %34 = load i64, i64* @t_copy, align 8
  store i64 %34, i64* @t, align 8
  %35 = load %struct.DataItem*, %struct.DataItem** @dummyItem_copy, align 8
  store %struct.DataItem* %35, %struct.DataItem** @dummyItem, align 8
  %36 = load [20 x %struct.DataItem*], [20 x %struct.DataItem*]* @hashArray_copy, align 8
  store [20 x %struct.DataItem*] %36, [20 x %struct.DataItem*]* @hashArray, align 8
  %37 = load i32, i32* @RANDOM_INIT_copy, align 4
  store i32 %37, i32* @RANDOM_INIT, align 4
  %38 = load [100 x i8*], [100 x i8*]* @PTRTRACKER_copy, align 8
  store [100 x i8*] %38, [100 x i8*]* @PTRTRACKER, align 8
  %39 = load i32, i32* @_ctr_copy, align 4
  store i32 %39, i32* @_ctr, align 4
  %40 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i64 0, i64 0))
  %41 = call i32 @start_main(i32 %0, i8** %1)
  br label %42
...
46:                                               ; preds = %8
  %47 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.2, i64 0, i64 0))
  ret i32 0
}
